...
const PROCUREMENT_COLUMNS = Object.freeze({
  reference: 0, requesterEmail: 1, supplier: 2, description: 3, currency: 4,
  amount: 5, status: 6, informationRequest: 7, informationResponse: 8,
  createdAt: 9, updatedAt: 10, reviewerEmail: 11, version: 12
});
...
function procurementBook_() {
  return SpreadsheetApp.openById(procurementProperty_('PROCUREMENT_SPREADSHEET_ID'));
}
...
function isProcurementReviewer_(email) {
  return procurementProperty_('PROCUREMENT_REVIEWER_EMAILS').split(',')
