...
const WEBHOOK_HEADERS = Object.freeze([
  'Received At', 'Event ID', 'Event Type', 'Payload JSON', 'Status',
  'Attempts', 'Next Retry At', 'Last Error', 'Processed At', 'Source'
]);
...
function webhookInbox_() {
  const sheet = SpreadsheetApp.openById(webhookProperty_('WEBHOOK_SPREADSHEET_ID')).getSheetByName(WEBHOOK_CONFIG.inboxSheet);
