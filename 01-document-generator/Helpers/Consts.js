...
function getDocumentGeneratorConfig_() {
  ...
  return {
    documentTemplateId: requiredDocumentProperty_(
      properties,
      DOCUMENT_GENERATOR.properties.documentTemplateId,
    ),
    spreadsheetTemplateId: requiredDocumentProperty_(
      properties,
      DOCUMENT_GENERATOR.properties.spreadsheetTemplateId,
    ),
    spreadsheetTemplateSheetName: cleanDocumentText_(
      properties.getProperty(
        DOCUMENT_GENERATOR.properties.spreadsheetTemplateSheetName,
      ),
    ),
  };
}
